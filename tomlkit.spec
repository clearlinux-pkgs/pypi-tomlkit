...
Source0  : https://files.pythonhosted.org/packages/af/fa/138d8bdcb0099876989c9d622f047ba106e82012cca066d310f1d75c9ed9/tomlkit-0.7.1.tar.gz
...
%prep
%setup -q -n tomlkit-0.7.1
cd %{_builddir}/tomlkit-0.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621472573
...
cp %{_builddir}/tomlkit-0.7.1/LICENSE %{buildroot}/usr/share/package-licenses/tomlkit/84661790a5df00ab944c2d37978d6ce5ac88e554
cp %{_builddir}/tomlkit-0.7.1/tests/toml-spec-tests/LICENSE %{buildroot}/usr/share/package-licenses/tomlkit/7ad2173ba59937a324cdfe33686e42e2f29ee6ae
