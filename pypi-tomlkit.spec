...
Source0  : https://files.pythonhosted.org/packages/b1/09/a439bec5888f00a54b8b9f05fa94d7f901d6735ef4e55dcec9bc37b5d8fa/tomlkit-0.13.2.tar.gz
...
%prep
%setup -q -n tomlkit-0.13.2
cd %{_builddir}/tomlkit-0.13.2
pushd ..
cp -a tomlkit-0.13.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723644644
