...
Source0  : https://files.pythonhosted.org/packages/2b/ab/18f4c8f2bec75eb1a7aebcc52cdb02ab04fd39ff7025bb1b1c7846cc45b8/tomlkit-0.12.5.tar.gz
...
%prep
%setup -q -n tomlkit-0.12.5
cd %{_builddir}/tomlkit-0.12.5
pushd ..
cp -a tomlkit-0.12.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715214743
