...
Source0  : https://files.pythonhosted.org/packages/84/51/092a8b945edc3b93f2de091ab9596006673caac063e3fac14f0fa6c69b1c/tomlkit-0.11.4.tar.gz
...
%prep
%setup -q -n tomlkit-0.11.4
cd %{_builddir}/tomlkit-0.11.4
pushd ..
cp -a tomlkit-0.11.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660518544
