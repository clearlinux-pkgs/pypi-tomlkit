...
Source0  : https://files.pythonhosted.org/packages/24/24/e50be8344fc6e9c9ae55bfcb136b33ad562776d822736da3d1ec0278b18b/tomlkit-0.11.0.tar.gz
...
%prep
%setup -q -n tomlkit-0.11.0
cd %{_builddir}/tomlkit-0.11.0
pushd ..
cp -a tomlkit-0.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656368276
...
cp %{_builddir}/tomlkit-0.11.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-tomlkit/84661790a5df00ab944c2d37978d6ce5ac88e554
cp %{_builddir}/tomlkit-0.11.0/tests/toml-spec-tests/LICENSE %{buildroot}/usr/share/package-licenses/pypi-tomlkit/7ad2173ba59937a324cdfe33686e42e2f29ee6ae
cp %{_builddir}/tomlkit-0.11.0/tests/toml-test/COPYING %{buildroot}/usr/share/package-licenses/pypi-tomlkit/7a82386b25eb7b8b4fbfd8427349ad9cdddf026d
