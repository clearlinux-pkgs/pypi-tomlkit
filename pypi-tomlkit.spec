...
Source0  : https://files.pythonhosted.org/packages/1e/81/93889ea6641154b22f26036bc4ef800b06df84fc647a6ded5abdc2f06dcf/tomlkit-0.11.1.tar.gz
...
%prep
%setup -q -n tomlkit-0.11.1
cd %{_builddir}/tomlkit-0.11.1
pushd ..
cp -a tomlkit-0.11.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657205591
...
cp %{_builddir}/tomlkit-0.11.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-tomlkit/84661790a5df00ab944c2d37978d6ce5ac88e554
cp %{_builddir}/tomlkit-0.11.1/tests/toml-spec-tests/LICENSE %{buildroot}/usr/share/package-licenses/pypi-tomlkit/7ad2173ba59937a324cdfe33686e42e2f29ee6ae
cp %{_builddir}/tomlkit-0.11.1/tests/toml-test/COPYING %{buildroot}/usr/share/package-licenses/pypi-tomlkit/7a82386b25eb7b8b4fbfd8427349ad9cdddf026d
