...
Source0  : https://files.pythonhosted.org/packages/ff/04/58b4c11430ed4b7b8f1723a5e4f20929d59361e9b17f0872d69681fd8ffd/tomlkit-0.11.6.tar.gz
...
%prep
%setup -q -n tomlkit-0.11.6
cd %{_builddir}/tomlkit-0.11.6
pushd ..
cp -a tomlkit-0.11.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666880560
