...
Source0  : https://files.pythonhosted.org/packages/7d/49/4c0764898ee67618996148bdba4534a422c5e698b4dbf4001f7c6f930797/tomlkit-0.12.4.tar.gz
...
%prep
%setup -q -n tomlkit-0.12.4
cd %{_builddir}/tomlkit-0.12.4
pushd ..
cp -a tomlkit-0.12.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709048342
