...
Source0  : https://files.pythonhosted.org/packages/ba/ce/b140a544f834a1789c0c05be42327e71980b1a36318fc8bed932daee219e/tomlkit-0.9.0.tar.gz
...
%prep
%setup -q -n tomlkit-0.9.0
cd %{_builddir}/tomlkit-0.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643756349
...
cp %{_builddir}/tomlkit-0.9.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-tomlkit/84661790a5df00ab944c2d37978d6ce5ac88e554
cp %{_builddir}/tomlkit-0.9.0/tests/toml-spec-tests/LICENSE %{buildroot}/usr/share/package-licenses/pypi-tomlkit/7ad2173ba59937a324cdfe33686e42e2f29ee6ae
cp %{_builddir}/tomlkit-0.9.0/tests/toml-test/COPYING %{buildroot}/usr/share/package-licenses/pypi-tomlkit/7a82386b25eb7b8b4fbfd8427349ad9cdddf026d
