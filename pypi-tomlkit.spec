...
Source0  : https://files.pythonhosted.org/packages/cc/18/0bbf3884e9eaa38819ebe46a7bd25dcd56b67434402b66a58c4b8e552575/tomlkit-0.13.3.tar.gz
...
%prep
%setup -q -n tomlkit-0.13.3
cd %{_builddir}/tomlkit-0.13.3
pushd ..
cp -a tomlkit-0.13.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749135358
