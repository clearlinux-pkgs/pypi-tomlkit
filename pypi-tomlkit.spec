...
Source0  : https://files.pythonhosted.org/packages/4b/34/f5f4fbc6b329c948a90468dd423aaa3c3bfc1e07d5a76deec269110f2f6e/tomlkit-0.13.0.tar.gz
...
%prep
%setup -q -n tomlkit-0.13.0
cd %{_builddir}/tomlkit-0.13.0
pushd ..
cp -a tomlkit-0.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720644360
